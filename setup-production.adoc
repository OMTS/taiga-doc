...
For run **taiga-back** you should have python (3.5) installed with some other third party
...
To run celery with taiga you have to include in your local.py the line:
